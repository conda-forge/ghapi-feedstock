...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ghapi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15201&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ghapi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ghapi` can be installed with:

```
conda install ghapi
```

It is possible to list all of the versions of `ghapi` available on your platform with:
